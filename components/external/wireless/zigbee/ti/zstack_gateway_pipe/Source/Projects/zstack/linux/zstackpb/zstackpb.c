...
static void sendSimpleDescRsp (uint16 srcAddr,
							 ZDO_SimpleDescRsp_t * pSimpleRsp);
...
void zspbInit (uint8 task_id)
{
	...
	ZMacSetJammerParameters (jammerContinuousEvents,
							 (jammerHighNoiseLevel * -1),
...
uint16 zspbProcessEvent (uint8 task_id, uint16 events)
{
	if (events & SYS_EVENT_MSG)
	{
		afIncomingMSGPacket_t *MSGpkt =
			(afIncomingMSGPacket_t *) osal_msg_receive (zspbTaskID);
		if (MSGpkt)
        {
                ...
                case ZDO_STATE_CHANGE:
                    {
                                    ...
                                    DEV_END_DEVICE)))
                        {
                            ...
                            ZDP_MgmtPermitJoinReq (&dstAddr, duration,
                                                    0, 0);
                        }
            ...
            case ZSTACK_CMD_IDS__SYS_SET_TX_POWER_REQ:
                {
                    ...
                    pTxReq =
                        sys_set_tx_power_req__unpack (NULL, len, pData);
                    if (pTxReq)
                    {
                        processSysSetTxPowerReq (connection, pTxReq);
                        sys_set_tx_power_req__free_unpacked (pTxReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__APS_REMOVE_GROUP:
                {
                    ...
                    pRemoveGroup =
                        aps_remove_group__unpack (NULL, len, pData);
                    if (pRemoveGroup)
                    {
                        processApsRemoveGroup (connection, pRemoveGroup);
                        aps_remove_group__free_unpacked (pRemoveGroup,
                                                            NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__APS_REMOVE_ALL_GROUPS:
                {
                    ...
                    pRemoveAllGroups =
                        aps_remove_all_groups__unpack (NULL, len, pData);
                    if (pRemoveAllGroups)
                    {
                        processApsRemoveAllGroups (connection,
                                                        pRemoveAllGroups);
                        aps_remove_all_groups__free_unpacked
                            (pRemoveAllGroups, NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__APS_FIND_ALL_GROUPS_REQ:
                {
                    ...
                    pFindAllGroupsReq =
                        aps_find_all_groups_req__unpack (NULL, len, pData);
                    if (pFindAllGroupsReq)
                    {
                        processApsFindAllGroupsReq (connection,
                                                    pFindAllGroupsReq);
                        aps_find_all_groups_req__free_unpacked
                            (pFindAllGroupsReq, NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__APS_FIND_GROUP_REQ:
                {
                    ...
                    pFindGroupReq =
                        aps_find_group_req__unpack (NULL, len, pData);
                    if (pFindGroupReq)
                    {
                        processApsFindGroupReq (connection,
                                                pFindGroupReq);
                        aps_find_group_req__free_unpacked (pFindGroupReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_APS_REMOVE_REQ:
                {
                    ...
                    pRemoveReq =
                        sec_aps_remove_req__unpack (NULL, len, pData);
                    if (pRemoveReq)
                    {
                        processSecApsRemoveReq (connection, pRemoveReq);
                        sec_aps_remove_req__free_unpacked (pRemoveReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_NWK_KEY_UPDATE_REQ:
                {
                    ...
                    pUpdateReq =
                        sec_nwk_key_update_req__unpack (NULL, len, pData);
                    if (pUpdateReq)
                    {
                        processSecNwkKeyUpdateReq (connection,
                                                        pUpdateReq);
                        sec_nwk_key_update_req__free_unpacked (pUpdateReq,
                                                                    NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_NWK_KEY_SWITCH_REQ:
                {
                    ...
                    pSwitchReq =
                        sec_nwk_key_switch_req__unpack (NULL, len, pData);
                    if (pSwitchReq)
                    {
                        processSecNwkKeySwitchReq (connection,
                                                        pSwitchReq);
                        sec_nwk_key_switch_req__free_unpacked (pSwitchReq,
                                                                    NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_NWK_KEY_SET_REQ:
                {
                    ...
                    pSetReq =
                        sec_nwk_key_set_req__unpack (NULL, len, pData);
                    if (pSetReq)
                    {
                        processSecNwkKeySetReq (connection, pSetReq);
                        sec_nwk_key_set_req__free_unpacked (pSetReq,
                                                            NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_NWK_KEY_GET_REQ:
                {
                    ...
                    pGetReq =
                        sec_nwk_key_get_req__unpack (NULL, len, pData);
                    if (pGetReq)
                    {
                        processSecNwkKeyGetReq (connection, pGetReq);
                        sec_nwk_key_get_req__free_unpacked (pGetReq,
                                                            NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_APS_LINKKEY_GET_REQ:
                {
                    ...
                    pGetReq =
                        sec_aps_link_key_get_req__unpack (NULL, len, pData);
                    if (pGetReq)
                    {
                        processSecApsLinkKeyGetReq (connection, pGetReq);
                        sec_aps_link_key_get_req__free_unpacked (pGetReq,
                                                                    NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_APS_LINKKEY_SET_REQ:
                {
                    ...
                    pSetReq =
                        sec_aps_link_key_set_req__unpack (NULL, len, pData);
                    if (pSetReq)
                    {
                        processSecApsLinkKeySetReq (connection, pSetReq);
                        sec_aps_link_key_set_req__free_unpacked (pSetReq,
                                                                    NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SEC_APS_LINKKEY_REMOVE_REQ:
                {
                    ...
                    pRemoveReq =
                        sec_aps_link_key_remove_req__unpack (NULL, len,
                                                                pData);
                    if (pRemoveReq)
                    {
                        processSecApsLinkKeyRemoveReq (connection,
                                                            pRemoveReq);
                        sec_aps_link_key_remove_req__free_unpacked
                            (pRemoveReq, NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__DEV_NWK_ROUTE_REQ:
                {
                    ...
                    pRouteReq =
                        dev_nwk_route_req__unpack (NULL, len, pData);
                    if (pRouteReq)
                    {
                        processDevNwkRouteReq (connection, pRouteReq);
                        dev_nwk_route_req__free_unpacked (pRouteReq,
                                                            NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__DEV_NWK_CHECK_ROUTE_REQ:
                {
                    ...
                    pCheckRouteReq =
                        dev_nwk_check_route_req__unpack (NULL, len, pData);
                    if (pCheckRouteReq)
                    {
                        processDevNwkCheckRouteReq (connection,
                                                    pCheckRouteReq);
                        dev_nwk_check_route_req__free_unpacked
                            (pCheckRouteReq, NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SYS_CONFIG_READ_REQ:
                {
                    ...
                    pSysConfigReadReq =
                        sys_config_read_req__unpack (NULL, len, pData);
                    if (pSysConfigReadReq)
                    {
                        processSysConfigReadReq (connection,
                                                    pSysConfigReadReq);
                        sys_config_read_req__free_unpacked
                            (pSysConfigReadReq, NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__SYS_CONFIG_WRITE_REQ:
                {
                    ...
                    pSysConfigWriteReq =
                        sys_config_write_req__unpack (NULL, len, pData);
                    if (pSysConfigWriteReq)
                    {
                        processSysConfigWriteReq (connection,
                                                    pSysConfigWriteReq);
                        sys_config_write_req__free_unpacked
                            (pSysConfigWriteReq, NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__AF_UNREGISTER_REQ:
                {
                    ...
                    pAfUnRegReq =
                        af_un_register_req__unpack (NULL, len, pData);
                    if (pAfUnRegReq)
                    {
                        processAfUnRegisterReq (connection, pAfUnRegReq);
                        af_un_register_req__free_unpacked (pAfUnRegReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__AF_CONFIG_GET_REQ:
                {
                    ...
                    pAConfigGetReq =
                        af_config_get_req__unpack (NULL, len, pData);
                    if (pAConfigGetReq)
                    {
                        processAfConfigGetReq (connection,
                                                    pAConfigGetReq);
                        af_config_get_req__free_unpacked (pAConfigGetReq,
                                                            NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__AF_CONFIG_SET_REQ:
                {
                    ...
                    pAConfigSetReq =
                        af_config_set_req__unpack (NULL, len, pData);
                    if (pAConfigSetReq)
                    {
                        processAfConfigSetReq (connection,
                                                    pAConfigSetReq);
                        af_config_set_req__free_unpacked (pAConfigSetReq,
                                                            NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__ZDO_ACTIVE_ENDPOINT_REQ:
                {
                    ...
                    pReq =
                        zdo_active_endpoint_req__unpack (NULL, len, pData);
                    if (pReq)
                    {
                        processZdoActiveEndpointsReq (connection, pReq);
                        zdo_active_endpoint_req__free_unpacked (pReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__ZDO_END_DEVICE_BIND_REQ:
                {
                    ...
                    pReq =
                        zdo_end_device_bind_req__unpack (NULL, len, pData);
                    if (pReq)
                    {
                        processZdoEndDeviceBindReq (connection, pReq);
                        zdo_end_device_bind_req__free_unpacked (pReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__ZDO_MGMT_PERMIT_JOIN_REQ:
                {
                    ...
                    pReq =
                        zdo_mgmt_permit_join_req__unpack (NULL, len, pData);
                    if (pReq)
                    {
                        processZdoMgmtPermitJoinReq (connection, pReq);
                        zdo_mgmt_permit_join_req__free_unpacked (pReq,
                                                                    NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__ZDO_MGMT_NWK_UPDATE_REQ:
                {
                    ...
                    pReq =
                        zdo_mgmt_nwk_update_req__unpack (NULL, len, pData);
                    if (pReq)
                    {
                        processZdoMgmtNwkUpdateReq (connection, pReq);
                        zdo_mgmt_nwk_update_req__free_unpacked (pReq,
                                                                NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__ZDO_MGMT_DIRECT_JOIN_REQ:
                {
                    ...
                    pReq =
                        zdo_mgmt_direct_join_req__unpack (NULL, len, pData);
                    if (pReq)
                    {
                        processZdoMgmtDirectJoinReq (connection, pReq);
                        zdo_mgmt_direct_join_req__free_unpacked (pReq,
                                                                    NULL);
                    }
                }
                break;
            ...
            case ZSTACK_CMD_IDS__ZDO_DEVICE_ANNOUNCE_REQ:
                {
                    ...
                    pReq =
                        zdo_device_announce_req__unpack (NULL, len, pData);
                    if (pReq)
                    {
                        processZdoDeviceAnnounceReq (connection, pReq);
                        zdo_device_announce_req__free_unpacked (pReq,
                                                                NULL);
                    }
                }
                break;
...
static void zspbProcessZDOMsgs (zdoIncomingMsg_t * inMsg)
{
	...
	switch (inMsg->clusterID)
	{
		...
		case End_Device_Timeout_rsp:
			{
				...
				sendEndDeviceTimeoutRsp (inMsg->srcAddr.addr.shortAddr,
										 timeout);
			}
			break;
		...
		case Mgmt_NWK_Disc_rsp:
			{
				ZDO_MgmNwkDiscRsp_t *pNwkDiscRsp =
					ZDO_ParseMgmNwkDiscRsp (inMsg);
				if (pNwkDiscRsp)
                {
                    sendMgmtNwkDiscRsp (inMsg->srcAddr.addr.shortAddr,
                                        pNwkDiscRsp);
		...
		case Mgmt_Bind_rsp:
			{
				...
				if (pBindRsp)
                {
                    sendMgmtBindRsp (inMsg->srcAddr.addr.shortAddr,
                                        pBindRsp);
...
static void processAfDataConfirm (afDataConfirm_t * pkt)
{
	...
	if (pBuf)
	{
		...
		if (pItem)
        {
            APIS_SendData (pItem->connection,
                            ZSTACK_SYS_IDS__RPC_SYS_PROTOBUF, TRUE,
									 ...
									 SecNwkKeyUpdateReq * pMsg)
{
	...
	{
		status =
			ZDSecMgrUpdateNwkKey (nwkKey.key, (uint8) pMsg->seqnum,
									(uint16) pMsg->dstaddr);
	}
#else
	status = ZSTATUS_VALUES__ZUnsupportedMode;
...
#if ( ZG_BUILD_COORDINATOR_TYPE )
	status =
		ZDSecMgrSwitchNwkKey ((uint8) pMsg->seqnum, (uint16) pMsg->dstaddr);
#else
	status = ZSTATUS_VALUES__ZUnsupportedMode;
#endif
										...
										SecApsLinkKeyGetReq * pMsg)
{
	...
	if (pMsg->tclinkkey)
	{
        ...
        {
            apsKeyRsp.status =
                osal_nv_read ((ZCD_NV_TCLK_TABLE_START + x), 0,
										...
										SecApsLinkKeySetReq * pMsg)
{
	...
	if (pMsg->tclinkkey)
	{
            ...
            if (status == ZSTATUS_VALUES__ZSuccess)
            {
                if (memcmp (&(pMsg->ieeeaddr), tcLinkKey.extAddr, 8) == 0)
                {
                    ...
                    break;
                            ...
                            && (memcmp (&(pMsg->ieeeaddr), dummyKey, 8) ==
                                0))
                {
                    // First empty spot
                    y = x;
		...
		if (y > 0)
        {
            ...
            tcLinkKey.txFrmCntr =
                (pMsg->has_txfrmcntr) ? pMsg->txfrmcntr : 0;
            tcLinkKey.rxFrmCntr =
                (pMsg->has_rxfrmcntr) ? pMsg->rxfrmcntr : 0;
	...
	else
	{
		...
		status =
			ZDSecMgrEntryLookupExt ((uint8 *) & (pMsg->ieeeaddr), &pEntry);
		if (status == ZSTATUS_VALUES__ZSuccess)
        {
            status =
                osal_nv_write (pEntry->keyNvId, 0,
		...
		for (x = 0; x < ZDSECMGR_TC_DEVICE_MAX; x++)
        {
            ...
            if (status == ZSTATUS_VALUES__ZSuccess)
            {
                if (memcmp (&(pMsg->ieeeaddr), tcLinkKey.extAddr, 8) == 0)
                {
                    ...
                    status =
                        osal_nv_write ((ZCD_NV_TCLK_TABLE_START + x), 0,
                                        sizeof (APSME_TCLinkKey_t),
                                        &tcLinkKey);
                    break;
                }
            }
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_PRECFGKEYS_ENABLE, 0, sizeof (zgPreConfigKeys),
						&zgPreConfigKeys);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_SECURITY_MODE, 0, sizeof (zgSecurityMode),
						&zgSecurityMode);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_USE_DEFAULT_TCLK, 0, sizeof (zgUseDefaultTCLK),
						&zgUseDefaultTCLK);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_QUEUED_POLL_RATE, 0, sizeof (zgQueuedPollRate),
						&zgQueuedPollRate);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_RESPONSE_POLL_RATE, 0,
						sizeof (zgResponsePollRate), &zgResponsePollRate);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_APS_ACK_WAIT_DURATION, 0,
						sizeof (zgApscAckWaitDurationPolled),
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_BINDING_TIME, 0,
						sizeof (zgApsDefaultMaxBindingTime),
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_PANID, 0, sizeof (zgConfigPANID),
						&zgConfigPANID);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_POLL_FAILURE_RETRIES, 0,
						sizeof (zgMaxPollFailureRetries),
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_INDIRECT_MSG_TIMEOUT, 0,
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_APS_FRAME_RETRIES, 0,
						sizeof (zgApscMaxFrameRetries), &zgApscMaxFrameRetries);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_BCAST_RETRIES, 0, sizeof (zgMaxBcastRetires),
						&zgMaxBcastRetires);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_PASSIVE_ACK_TIMEOUT, 0,
						sizeof (zgPassiveAckTimeout), &zgPassiveAckTimeout);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_BCAST_DELIVERY_TIME, 0,
						sizeof (zgBcastDeliveryTime), &zgBcastDeliveryTime);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_ROUTE_EXPIRY_TIME, 0, sizeof (zgRouteExpiryTime),
						&zgRouteExpiryTime);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_CHANLIST, 0, sizeof (zgDefaultChannelList),
						&zgDefaultChannelList);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_APS_NONMEMBER_RADIUS, 0,
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_APS_USE_EXT_PANID, 0,
						sizeof (zgApsUseExtendedPANID), &zgApsUseExtendedPANID);
#endif
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_CONCENTRATOR_ENABLE, 0,
...
#if defined ( LINUX_ZNP )
		osal_nv_read (ZCD_NV_CONCENTRATOR_DISCOVERY, 0,
						sizeof (zgConcentratorDiscoveryTime),
...
static void processSysConfigWriteReq (int connection, SysConfigWriteReq * pMsg)
{
	...
	if (pMsg->has_responsepollrate)
	{
		...
		osal_nv_write (ZCD_NV_RESPONSE_POLL_RATE, 0,
						 sizeof (zgResponsePollRate), &zgResponsePollRate);
	}
	...
	if (pMsg->has_bindingtime)
	{
		...
		osal_nv_write (ZCD_NV_BINDING_TIME, 0,
						 sizeof (zgApsDefaultMaxBindingTime),
						 &zgApsDefaultMaxBindingTime);
	}
	...
	if (pMsg->has_panid)
	{
		...
		osal_nv_write (ZCD_NV_PANID, 0, sizeof (zgConfigPANID),
						 &zgConfigPANID);
	}
	...
	if (pMsg->has_apsframeretries)
	{
		...
		osal_nv_write (ZCD_NV_APS_FRAME_RETRIES, 0,
						 sizeof (zgApscMaxFrameRetries),
	...
	if (pMsg->has_passiveacktimeout)
	{
		...
		osal_nv_write (ZCD_NV_PASSIVE_ACK_TIMEOUT, 0,
						 sizeof (zgPassiveAckTimeout), &zgPassiveAckTimeout);
	}
	...
	if (pMsg->has_bcastdeliverytime)
	{
		...
		osal_nv_write (ZCD_NV_BCAST_DELIVERY_TIME, 0,
						 sizeof (zgBcastDeliveryTime), &zgBcastDeliveryTime);
	}
	...
	if (pMsg->has_routeexpirytime)
	{
		...
		osal_nv_write (ZCD_NV_ROUTE_EXPIRY_TIME, 0,
						 sizeof (zgRouteExpiryTime), &zgRouteExpiryTime);
	}
...
static void processAfRegisterReq (int connection, AfRegisterReq * pMsg)
{
	...
	else
	{
		...
		if (pItem)
        {
            ...
            pItem->epDesc.simpleDesc =
                (SimpleDescriptionFormat_t *)
                malloc (sizeof (SimpleDescriptionFormat_t));
            if (pItem->epDesc.simpleDesc)
            {
                ...
                pItem->epDesc.simpleDesc->AppDevVer =
                    pMsg->simpledesc->devicever;
                pItem->epDesc.simpleDesc->AppDeviceId =
                    pMsg->simpledesc->deviceid;
                pItem->epDesc.simpleDesc->EndPoint =
                    pMsg->simpledesc->endpoint;
                ...
                pItem->epDesc.simpleDesc->AppProfId =
                    pMsg->simpledesc->profileid;
                pItem->epDesc.simpleDesc->pAppInClusterList =
                    (cId_t *) malloc (sizeof (cId_t) *
                                        pItem->epDesc.simpleDesc->
                                        AppNumInClusters);
                if (pItem->epDesc.simpleDesc->pAppInClusterList)
                {
                    for (i = 0;
                            i < pItem->epDesc.simpleDesc->AppNumInClusters;
                            i++)
                    {
                        pItem->epDesc.simpleDesc->
                            pAppInClusterList[i] =
            ...
            else
            {
                ...
                else
                {
                    ...
                    memset (&(pItem->epDesc), 0,
                            sizeof (endPointDesc_t));
                }
            }
...
static void processAfDataReq (int connection, AfDataReq * pMsg)
{
	...
	else
	{
		...
		if (pEPDesc)
        {
            ...
            {
                memcpy (dstAddr.addr.extAddr, &(pMsg->dstaddr->extaddr),
                        8);
            }
            ...
            {
                uint16 *pList =
                    malloc (sizeof (uint16) * pMsg->n_relaylist);
                if (pList)
                {
                    int i;
            ...
            {
                status =
                    AF_DataRequest (&dstAddr, pEPDesc,
                                    (uint16) pMsg->clusterid,
                                    (uint16) pMsg->payload.len,
                                    (uint8 *) pMsg->payload.data,
                                    &transId, txOptions,
                                    (uint8) pMsg->radius);
            }
        }
...
static void processZdoMatchDescReq (int connection, ZdoMatchDescReq * pMsg)
{
	...
	{
		inClusters =
			(uint16 *) malloc (sizeof (uint16) * pMsg->n_inputclusters);
        if (inClusters)
        {
	...
	{
		outClusters =
			(uint16 *) malloc (sizeof (uint16) * pMsg->n_outputclusters);
		if (outClusters)
        {
	...
	status = ZDP_MatchDescReq (&dstAddr, (uint16) pMsg->nwkaddrofinterest,
							 (uint16) pMsg->profileid,
							 (uint8) pMsg->n_inputclusters, inClusters,
							 (uint8) pMsg->n_outputclusters, outClusters,
							 FALSE);
...
static void processZdoNodeDescReq (int connection, ZdoNodeDescReq * pMsg)
{
	...
	status =
		ZDP_NodeDescReq (&dstAddr, (uint16) pMsg->nwkaddrofinterest, FALSE);
										...
										ZdoActiveEndpointReq * pMsg)
{
	...
	status =
		ZDP_ActiveEPReq (&dstAddr, (uint16) pMsg->nwkaddrofinterest, FALSE);
										...
										ZdoEndDeviceBindReq * pMsg)
{
	...
	status = ZDP_EndDeviceBindReq (&dstAddr, (uint16) pMsg->localcoordinator,
								 (uint8) pMsg->endpoint,
								 (uint16) pMsg->profileid,
								 (uint8) pMsg->n_inputclusters, inList,
								 (uint8) pMsg->n_outputclusters, outList,
								 FALSE);
...
static void processZdoBindReq (int connection, ZdoBindReq * pMsg)
{
	...
	{
		memcpy (destinationAddr.addr.extAddr,
				&(pMsg->bindinfo->dstaddr->extaddr), 8);
	}

	status = ZDP_BindUnbindReq (Bind_req, &dstAddr, srcAddr,
								(uint8) pMsg->bindinfo->srcendpoint,
								(cId_t) pMsg->bindinfo->clusterid,
								&destinationAddr,
								(uint8) pMsg->bindinfo->dstaddr->endpoint,
								FALSE);
...
static void processZdoUserDescReq (int connection, ZdoUserDescReq * pMsg)
{
	...
	status =
		ZDP_UserDescReq (&dstAddr, (uint16) pMsg->nwkaddrofinterest, FALSE);
										 ...
										 ZdoMgmtPermitJoinReq * pMsg)
{
		...
		|| (pMsg->nwkaddr == 0xFFFC))
	{
		...
		status =
			(uint8) ZDP_MgmtPermitJoinReq (&dstAddr, (uint8) pMsg->duration,
											 (uint8) pMsg->tcsignificance,
											 FALSE);
	}
...
static void processZdoMgmtLeaveReq (int connection, ZdoMgmtLeaveReq * pMsg)
{
		...
		|| (pMsg->nwkaddr == 0xFFFC))
	{
		...
		status = (uint8) ZDP_MgmtLeaveReq (&dstAddr, ieeeAddr,
											 pMsg->options->removechildren,
											 pMsg->options->rejoin, FALSE);
	}
										...
										ZdoMgmtNwkUpdateReq * pMsg)
{
	...
	status = (uint8) ZDP_MgmtNwkUpdateReq (&dstAddr, pMsg->channelmask,
										 (uint8) pMsg->scanduration,
										 (uint8) pMsg->scancount,
										 (uint8) pMsg->nwkupdateid,
										 (uint16) pMsg->nwkmgraddr);
...
static void sendMsgToAllCBs (int len, uint8 * pBuf, uint16 cbMask, uint8 cmdId)
{
	...
	while (srch)
	{
        ...
        {
            // Send the AREQ message
            APIS_SendData (srch->connection,
                            ZSTACK_SYS_IDS__RPC_SYS_PROTOBUF, TRUE, cmdId,
                            len, pBuf);
        }
...
void *zdoSrcRtgCB (void *pStr)
{
	...
	if (pSrcRtg->relayCnt)
	{
		int i;
		srcRtgInd.relay =
			(uint32_t *) malloc (sizeof (uint32_t) * pSrcRtg->relayCnt);
...
static void sendNwkAddrRsp (ZDO_NwkIEEEAddrResp_t * pAddrRsp)
{
	...
	{
		nwkAddrRsp.assocdevlist =
			(uint32_t *) malloc (sizeof (uint32_t) * pAddrRsp->numAssocDevs);
...
static void sendSimpleDescRsp (uint16 srcAddr, ZDO_SimpleDescRsp_t * pSimpleRsp)
{
	...
	simpleDesc.inputclusters =
		(uint32_t *) malloc (sizeof (uint32_t) *
							 pSimpleRsp->simpleDesc.AppNumInClusters);
	if (simpleDesc.inputclusters)
	{
		for (i = 0; i < simpleDesc.n_inputclusters; i++)
        {
            simpleDesc.inputclusters[i] =
                pSimpleRsp->simpleDesc.pAppInClusterList[i];
        }
	}

	simpleDesc.outputclusters =
		(uint32_t *) malloc (sizeof (uint32_t) *
							 pSimpleRsp->simpleDesc.AppNumOutClusters);
							 ...
							 ZDO_ActiveEndpointRsp_t * pActiveEPRsp)
{
	...
	epRsp.activeeplist =
		(uint32_t *) malloc (sizeof (uint32_t) * pActiveEPRsp->cnt);
								...
								ZDO_MgmNwkDiscRsp_t * pNwkDiscRsp)
{
	...
	ndRsp.netlist =
		(NwkDiscItem **) malloc (sizeof (NwkDiscItem *) * ndRsp.n_netlist);
	if (ndRsp.netlist)
	{
		int len;
		int x;
        ...
        {
            ndRsp.netlist[x] =
                (NwkDiscItem *) malloc (sizeof (NwkDiscItem));
            nwk_disc_item__init (ndRsp.netlist[x]);
            memcpy (&(ndRsp.netlist[x]->extendedpanid),
                    pNwkDiscRsp->list[x].extendedPANID, 8);
            ndRsp.netlist[x]->logicalchan =
                pNwkDiscRsp->list[x].logicalChannel;
            ndRsp.netlist[x]->stackprofile =
                pNwkDiscRsp->list[x].stackProfile;
            ndRsp.netlist[x]->version = pNwkDiscRsp->list[x].version;
            ndRsp.netlist[x]->beaconorder =
                pNwkDiscRsp->list[x].beaconOrder;
            ndRsp.netlist[x]->superframeorder =
                pNwkDiscRsp->list[x].superFrameOrder;
            ndRsp.netlist[x]->permitjoin =
                pNwkDiscRsp->list[x].permitJoining;
        }
...
static void sendMgmtLqiRsp (uint16 srcAddr, ZDO_MgmtLqiRsp_t * pLqiRsp)
{
	...
	lqiRsp.lqilist =
		(NeighborLqiItem **) malloc (sizeof (NeighborLqiItem *) *
									 lqiRsp.n_lqilist);
	if (lqiRsp.lqilist)
	{
		int len;
		...
		for (x = 0; x < lqiRsp.n_lqilist; x++)
        {
            ...
            memcpy (&(lqiRsp.lqilist[x]->extendedpanid),
                    pLqiRsp->list[x].extPanID, 8);
            memcpy (&(lqiRsp.lqilist[x]->extendedaddr),
                    pLqiRsp->list[x].extAddr, 8);
...
static void sendMgmtRtgRsp (uint16 srcAddr, ZDO_MgmtRtgRsp_t * pRtgRsp)
{
	...
	rtgRsp.rtglist =
		(RtgItem **) malloc (sizeof (RtgItem *) * rtgRsp.n_rtglist);
	if (rtgRsp.rtglist)
	{
		int len;
		int x;
...
static void sendMgmtBindRsp (uint16 srcAddr, ZDO_MgmtBindRsp_t * pBindRsp)
{
	...
	bindRsp.bindlist =
		(BindItem **) malloc (sizeof (BindItem *) * bindRsp.n_bindlist);
	if (bindRsp.bindlist)
	{
		int len;
		int x;
		for (x = 0; x < bindRsp.n_bindlist; x++)
        {
            ...
            memcpy (&(bindRsp.bindlist[x]->srcaddr),
                    pBindRsp->list[x].srcAddr, 8);
            bindRsp.bindlist[x]->srcendpoint = pBindRsp->list[x].srcEP;
            bindRsp.bindlist[x]->clustedid = pBindRsp->list[x].clusterID;

            bindRsp.bindlist[x]->dstaddr =
                (AFAddr *) malloc (sizeof (AFAddr));
            ...
            bindRsp.bindlist[x]->dstaddr->endpoint =
                pBindRsp->list[x].dstEP;
        }
									 ...
									 ZDO_MgmtNwkUpdateNotify_t * pNotify)
{
	...
	nuNot.energyvalueslist =
		malloc (sizeof (uint32_t) * nuNot.n_energyvalueslist);
	if (nuNot.energyvalueslist)
	{
		...
		if (pBuf)
        {
            ...
            sendMsgToAllCBMsgs (len, pBuf,
                                ZS_ZDO_MGMT_NWK_UPDATE_NOTIFY_CDID,
